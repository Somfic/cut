...
use crate::timeline::{Clip, Timeline, timeline};
use crate::video::{Frame, Player, SeekMode, Source, VideoView};
...
/// Demo: lay this many clips of the one source, each this long, from random
/// moments in the file.
