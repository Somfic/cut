...
/// gstreamer's rational, as the document counts them.
pub(crate) fn rational(fraction: gstreamer::Fraction) -> Rational {
    Rational::new(fraction.numer(), fraction.denom())
}
